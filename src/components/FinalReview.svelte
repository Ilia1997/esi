...
<style>
  ...
  .pop__up__head {
    ...
    padding: 35px;
    /* dark-green */
    background: linear-gradient(249.52deg, #0c9532 0%, #17cc49 100%);
    position: relative;
